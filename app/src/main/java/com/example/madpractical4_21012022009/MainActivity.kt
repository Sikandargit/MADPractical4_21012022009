package com.example.madpractical4_21012022009
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnBrowse:Button=findViewById(R.id.btn_1)
        val txtBrowse:EditText=findViewById(R.id.text_browser)
        val btnCall:Button=findViewById(R.id.btn_2)
        val txtCall:EditText=findViewById(R.id.text_call)
        val txtAlarm:EditText=findViewById(R.id.text_Alarm)

        val btnContact:Button=findViewById(R.id.btn_3)
        val btnCallLog:Button=findViewById(R.id.btn_4)
        val btnGallery:Button=findViewById(R.id.btn_5)
        val btnCamera:Button=findViewById(R.id.btn_6)
        val btnAlarm:Button=findViewById(R.id.btn_7)
